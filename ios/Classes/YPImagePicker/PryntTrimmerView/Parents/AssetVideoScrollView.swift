...
class AssetVideoScrollView: UIScrollView {
    ...
    private var thisWidthConstraint: NSLayoutConstraint?
    ...
    private func setupSubviews() {
        ...
        thisWidthConstraint = contentView.widthAnchor.constraint(equalTo: widthAnchor, multiplier: 1.0)
        thisWidthConstraint?.isActive = true
    }
    ...
    private func setContentSize(for asset: AVAsset) -> CGSize {
        ...
        thisWidthConstraint?.isActive = false
        thisWidthConstraint = contentView.widthAnchor.constraint(equalTo: widthAnchor, multiplier: contentWidthFactor)
        thisWidthConstraint?.isActive = true
        layoutIfNeeded()
